      ...
      <main className="flex-1 flex flex-col">
        <div className="bg-slate-900 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 relative z-10 text-center">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-white tracking-tight mb-6 sm:mb-8">Enterprise <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Life Cycle Assessment</span> Software</h1>
                <p className="mt-4 text-base sm:text-xl text-slate-300 max-w-3xl mx-auto font-medium leading-relaxed mb-8 sm:mb-10 px-2">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
                    <button onClick={() => document.getElementById('calculator-workspace')?.scrollIntoView({ behavior: 'smooth' })} className="bg-emerald-500 hover:bg-emerald-400 text-white px-8 py-4 rounded-lg text-base sm:text-lg font-black shadow-lg shadow-emerald-500/30 transition-all flex items-center justify-center gap-2">
                    ...
                    <button onClick={() => document.getElementById('seo-content')?.scrollIntoView({ behavior: 'smooth' })} className="bg-slate-800 hover:bg-slate-700 border border-slate-600 text-white px-8 py-4 rounded-lg text-base sm:text-lg font-bold transition-all">Read Methodology</button>
                </div>
            </div>
        </div>

        <div id="calculator-workspace" className="max-w-[1400px] w-full mx-auto px-2 sm:px-6 lg:px-8 py-8 sm:py-16 overflow-x-hidden">
            <LcaEngineComponent />
        </div>

        <div id="seo-content" className="bg-white border-t border-slate-200 py-16 sm:py-20">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 sm:mb-16">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-slate-900 mb-4 px-2">Advanced Life Cycle Assessment Software for Modern Engineering</h2>
                    <p className="text-base sm:text-lg text-slate-600 font-medium px-2">Why architectural firms rely on Green Engineering Tools to manage their carbon accounting workflows.</p>
                </div>
                
                <div className="prose prose-lg prose-slate max-w-none">
                    <p className="px-2">In the modern AEC (Architecture, Engineering, and Construction) industry, managing a building's environmental footprint is no longer optional. Our <strong>embodied carbon calculator</strong> provides precise, EN-15804 compliant tracking for architectural materials across their entire lifecycle—from Phase A (Manufacturing and Construction) to Phase C (End of Life).</p>
                    
                    <div className="grid md:grid-cols-3 gap-6 sm:gap-8 my-8 sm:my-12 not-prose">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-6">
                    {[
                        ...
                        <div key={i} className="bg-white border border-slate-200 p-5 sm:p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                            <h4 className="text-base sm:text-lg font-bold text-slate-900 mb-2 flex items-start gap-3"><span className="text-emerald-500">Q.</span> {faq.q}</h4>
                            <p className="text-sm sm:text-base text-slate-600 leading-relaxed ml-7">{faq.a}</p>
                        </div>
                    ))}
                </div>
            </div>
...
function LcaEngineComponent() {
  ...
  return (
    <div className="w-full bg-white rounded-sm shadow-xl overflow-hidden border border-gray-200 relative mt-4 sm:mt-8 mb-12 sm:mb-16">
      ...
      {showRevitModal && (
        <div className="fixed inset-0 z-[100] bg-slate-900/90 backdrop-blur-sm flex items-center justify-center p-4 h-screen w-screen text-left">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-3xl flex flex-col relative overflow-hidden max-h-[90vh]">
                <div className="p-4 sm:p-6 bg-slate-900 text-white flex justify-between items-center">
                    <div><h2 className="text-lg sm:text-xl font-bold flex items-center gap-2"><svg className="w-6 h-6 text-blue-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /></svg> Revit / C# BIM Webhook</h2></div>
                ...
                <div className="p-4 sm:p-8 space-y-6 overflow-y-auto">
                    <p className="text-slate-600 font-semibold text-sm sm:text-base">Bypass CSV uploads entirely. Use this secure endpoint to pipe material schedules directly from your custom C# Revit Add-in into this web application.</p>
                    <div className="bg-slate-50 border border-slate-200 p-3 sm:p-4 rounded-lg">
                        ...
                        <code className="text-blue-700 font-mono text-xs sm:text-sm font-bold block p-2 bg-blue-50 border border-blue-200 rounded break-all">POST https://greenengineeringtools.com/api/webhook/revit</code>
                    </div>
                    <div>
                        ...
                        <pre className="bg-slate-900 text-slate-300 p-3 sm:p-4 rounded-lg text-xs font-mono overflow-x-auto text-left">
    ...
    if(response.IsSuccessStatusCode) {
      ...
      {pendingReconciliation && (
        <div className="fixed inset-0 z-[100] bg-slate-900/90 backdrop-blur-sm flex items-center justify-center p-4 h-screen w-screen overflow-hidden text-left">
           <div className="bg-white border border-slate-200 shadow-xl rounded-xl p-4 sm:p-8 max-w-4xl w-full max-h-[90vh] flex flex-col relative mx-4">
              <div className="flex items-center gap-3 mb-2">
                 ...
                 <h3 className="text-xl sm:text-2xl font-bold text-slate-900">Link Global EC3 EPDs</h3>
              </div>
              <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base sm:ml-11">We found materials in your CAD export that are not in your local database. Search the official EC3 Global Database to link them to verified manufacturer EPDs.</p>

              <div className="space-y-4 overflow-y-auto pr-2 flex-1">
                 {pendingReconciliation.uniqueMaterials.map(matName => (
                    <div key={matName} className={`p-4 sm:p-5 border-2 rounded-lg transition-colors ${selectedEpds[matName] ? 'border-green-300 bg-green-50' : 'border-slate-200 bg-slate-50'}`}>
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 mb-3">
                            <span className="font-bold text-slate-800 text-base sm:text-lg break-all">{matName}</span>
                            {selectedEpds[matName] ? 
                                <span className="bg-green-200 text-green-800 text-xs px-2 py-1 rounded font-bold uppercase tracking-wider flex items-center gap-1 shrink-0"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Verified Link</span> 
                                : <span className="bg-orange-100 text-orange-800 text-xs px-2 py-1 rounded font-bold uppercase tracking-wider flex items-center gap-1 shrink-0"><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg> Action Required</span>
                            }
                        </div>
                        <div className="flex flex-col sm:flex-row gap-2 mb-2">
                            <input type="text" id={`search-${matName}`} defaultValue={matName.split(',')[0]} className="flex-1 px-4 py-2 border-2 border-slate-300 rounded font-bold text-slate-900 focus:border-blue-600 outline-none shadow-inner text-sm" />
                            <button onClick={() => {
                                const q = (document.getElementById(`search-${matName}`) as HTMLInputElement).value;
                                searchEc3(matName, q);
                            }} className="bg-slate-800 text-white px-6 py-2 rounded font-bold hover:bg-slate-700 sm:min-w-[140px] flex justify-center items-center transition-colors text-sm">
                        ...
                        {ec3SearchResults[matName] && ec3SearchResults[matName].length === 0 && (
                            <div className="mt-2 text-xs sm:text-sm font-bold text-red-600">
                        ...
                        {ec3SearchResults[matName] && ec3SearchResults[matName].length > 0 && (
                            <div className="mt-3">
                                ...
                                <select 
                                    ...
                                    className="w-full p-2.5 sm:p-3 border-2 border-blue-300 bg-white text-slate-900 rounded font-semibold outline-none shadow-sm text-sm"
                                >
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3 mt-6 border-t border-slate-200 pt-4 sm:pt-6">
                 ...
                 <button 
                    ...
                    className="px-6 py-3 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded shadow disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
                 >
      ...
      {showAssemblyBuilder && (
        <div className="fixed inset-0 z-[100] bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-4 text-left">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col mx-4">
                <div className="p-4 sm:p-6 border-b border-slate-200 flex justify-between items-center bg-slate-50 rounded-t-xl">
                    <div><h2 className="text-lg sm:text-xl font-bold text-slate-900">Assembly Builder</h2><p className="text-xs sm:text-sm text-slate-500">Combine raw materials into a custom architectural system.</p></div>
                ...
                <div className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-4">
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                        ...
                        {assemblyForm.items.map((item, idx) => (
                            <div key={idx} className="flex gap-2 sm:gap-3 mb-3 items-center">
                                <select value={item.name} onChange={e => handleAssemblyComponentChange(idx, 'name', e.target.value)} className="flex-1 bg-white border-2 border-slate-300 p-2 rounded text-xs sm:text-sm text-slate-900"><option value="">Select Material...</option>{Object.keys(epdDatabase).map(mat => <option key={mat} value={mat}>{mat}</option>)}</select>
                                <input type="number" value={item.qty} onChange={e => handleAssemblyComponentChange(idx, 'qty', safeNum(e.target.value))} className="w-20 sm:w-24 text-right bg-white border-2 border-slate-300 p-2 rounded text-xs sm:text-sm font-mono text-slate-900" placeholder="Qty" />
                ...
                <div className="p-4 sm:p-6 border-t border-slate-200 bg-slate-50 flex justify-end gap-3 rounded-b-xl">
      ...
      {/* --- HEADER CONTROLS --- */}
      <div className="bg-slate-900 px-4 sm:px-6 py-4 sm:py-5 flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-4 border-b border-slate-800 text-left rounded-t-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
            <h3 className="text-white font-bold text-base sm:text-lg tracking-tight">Enterprise LCA Engine</h3>
            <button onClick={() => setShowAssemblyBuilder(true)} className="bg-slate-800 hover:bg-slate-700 text-blue-400 px-3 py-1.5 rounded text-xs font-bold border border-slate-700 transition-colors">+ Build Assembly</button>
        </div>
        
        <div className="flex flex-wrap items-center gap-3">
          {!pendingUpload && hasData && (
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:border-r sm:border-slate-700 sm:pr-4 w-full lg:w-auto">
                <div className="flex items-center justify-between sm:justify-start gap-2 text-xs sm:text-sm text-slate-300">
                   <label className="font-semibold">B4 Lifespan:</label>
                   <input type="number" value={buildingLifespan} onChange={(e) => setBuildingLifespan(Number(e.target.value))} className="w-16 px-2 py-1 bg-slate-800 border border-slate-600 rounded text-white text-center focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm" />
                </div>
                <div className="flex items-center justify-between sm:justify-start gap-2 text-xs sm:text-sm text-slate-300">
                   <label className="font-semibold">Grid Carbon (kg/kWh):</label>
                   <input type="number" step="0.01" value={gridIntensity} onChange={(e) => setGridIntensity(Number(e.target.value))} className="w-20 px-2 py-1 bg-slate-800 border border-slate-600 rounded text-white text-center focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm" />
                </div>
            </div>
          )}
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
              {!pendingUpload && hasData && (
                <button onClick={() => setShowRevitModal(true)} className="bg-indigo-600 hover:bg-indigo-500 text-white border border-indigo-400 px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold rounded shadow-sm flex items-center justify-center gap-2 flex-1 sm:flex-none">
                    <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg> BIM Sync
                </button>
              )}
              
              {hasData && !pendingUpload && (
                <>
                  <button onClick={() => baselineInputRef.current?.click()} className={`px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold rounded shadow-sm transition-colors border flex-1 sm:flex-none text-center ${baselineBOM.length > 0 ? 'bg-slate-700 hover:bg-slate-600 text-white border-slate-500' : 'bg-orange-100 hover:bg-orange-200 text-orange-800 border-orange-300 animate-pulse'}`}>
                    {baselineBOM.length > 0 ? 'Update Baseline' : 'Upload Baseline'}
                  </button>
                  <button onClick={() => proposedInputRef.current?.click()} className={`px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold rounded shadow-sm transition-colors border flex-1 sm:flex-none text-center ${proposedBOM.length > 0 ? 'bg-blue-600 hover:bg-blue-500 text-white border-blue-500' : 'bg-orange-100 hover:bg-orange-200 text-orange-800 border-orange-300 animate-pulse'}`}>
                    {proposedBOM.length > 0 ? 'Update Proposed' : 'Upload Proposed'}
                  </button>
                </>
              )}
          </div>
      ...
      {pendingUpload ? (
        <div className="bg-slate-50 p-4 sm:p-10 min-h-[400px] sm:min-h-[500px] flex items-center justify-center text-left rounded-b-sm">
           <div className="bg-white border border-slate-200 shadow-xl rounded-xl p-6 sm:p-8 max-w-3xl w-full mx-2">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-6">Data Mapping Required</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8">
                 <div><label className="block text-xs sm:text-sm font-bold text-slate-700 mb-2">Material Name Column</label><select value={columnMapping.material} onChange={e => setColumnMapping({...columnMapping, material: e.target.value})} className="w-full bg-white text-slate-900 border-2 border-slate-300 rounded p-2 text-sm"><option value="">-- Select --</option>{pendingUpload.headers.map((h, i) => <option key={i} value={h}>{h}</option>)}</select></div>
                 <div><label className="block text-xs sm:text-sm font-bold text-slate-700 mb-2">Quantity Column</label><select value={columnMapping.quantity} onChange={e => setColumnMapping({...columnMapping, quantity: e.target.value})} className="w-full bg-white text-slate-900 border-2 border-slate-300 rounded p-2 text-sm"><option value="">-- Select --</option>{pendingUpload.headers.map((h, i) => <option key={i} value={h}>{h}</option>)}</select></div>
                 <div><label className="block text-xs sm:text-sm font-bold text-slate-700 mb-2">Unit Column</label><select value={columnMapping.unit} onChange={e => setColumnMapping({...columnMapping, unit: e.target.value})} className="w-full bg-white text-slate-900 border-2 border-slate-300 rounded p-2 text-sm"><option value="">-- Select --</option>{pendingUpload.headers.map((h, i) => <option key={i} value={h}>{h}</option>)}</select></div>
              </div>
        ...
        <>
          {hasData && (
            <div className="flex bg-slate-50 text-xs sm:text-sm font-semibold text-slate-500 overflow-x-auto shadow-inner border-b border-slate-200 text-left scrollbar-thin">
              {[{ id: 'manufacturing', label: 'A1-A3: Manufacturing' }, { id: 'construction', label: 'A4-A5: Construction' }, { id: 'use', label: 'B1-B7: Use (Crossover)' }, { id: 'eol', label: 'C1-C4 + Mod D: End of Life' }, { id: 'procurement', label: 'Bid Leveling / Cost' }].map((tab) => (
                <button key={tab.id} onClick={() => setActiveTab(tab.id as any)} className={`flex-none sm:flex-1 px-4 sm:px-6 py-3 sm:py-4 transition-all whitespace-nowrap border-b-2 ${activeTab === tab.id ? 'border-blue-600 text-blue-700 bg-white shadow-sm font-bold' : 'border-transparent hover:text-slate-800 hover:bg-slate-100'}`}>{tab.label}</button>
              ))}
            </div>
          )}
          
          <div className="p-4 sm:p-8 min-h-[500px] bg-slate-50 text-left rounded-b-sm">
            {/* --- EMPTY STATE START DASHBOARD --- */}
            {!hasData ? (
              <div className="flex flex-col items-center justify-center h-full py-12 sm:py-16">
                <h4 className="text-2xl sm:text-3xl font-black text-slate-900 mb-3 sm:mb-4 text-center">Select Engineering Workflow</h4>
                <p className="text-slate-500 max-w-2xl text-center mb-8 sm:mb-12 text-sm sm:text-base px-2">Choose how you want to interact with the engine. Run a single structural analysis, or perform a full LEED v4 standard baseline comparison.</p>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full px-2 sm:px-4">
                    <div onClick={() => proposedInputRef.current?.click()} className="bg-white border-2 border-dashed border-slate-300 hover:border-blue-500 hover:bg-blue-50 rounded-xl p-6 sm:p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all group shadow-sm hover:shadow-md">
                    ...
                    <div onClick={() => baselineInputRef.current?.click()} className="bg-white border-2 border-dashed border-slate-300 hover:border-emerald-500 hover:bg-emerald-50 rounded-xl p-6 sm:p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all group shadow-sm hover:shadow-md">
                    ...
                    <div onClick={() => setShowRevitModal(true)} className="bg-white border-2 border-dashed border-slate-300 hover:border-indigo-500 hover:bg-indigo-50 rounded-xl p-6 sm:p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all group shadow-sm hover:shadow-md">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                    {isComparing ? (
                        <>
                            <div className="flex bg-slate-200 p-1 rounded-lg w-full sm:w-fit shadow-inner overflow-x-auto">
                                <button onClick={() => setActiveView('baseline')} className={`flex-1 sm:flex-none px-4 sm:px-6 py-2 rounded-md text-xs sm:text-sm font-bold transition-colors whitespace-nowrap ${activeView === 'baseline' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}>Baseline Model</button>
                                <button onClick={() => setActiveView('proposed')} className={`flex-1 sm:flex-none px-4 sm:px-6 py-2 rounded-md text-xs sm:text-sm font-bold transition-colors whitespace-nowrap ${activeView === 'proposed' ? 'bg-white text-blue-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}>Proposed Model</button>
                                <button onClick={() => setActiveView('comparison')} className={`flex-1 sm:flex-none px-4 sm:px-6 py-2 rounded-md text-xs sm:text-sm font-bold transition-colors whitespace-nowrap ${activeView === 'comparison' ? 'bg-slate-900 text-white shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}>LEED Matrix</button>
                            </div>
                            <div className="flex gap-2">
                                <button onClick={generateCSV} className="bg-white text-blue-700 hover:bg-blue-100 border border-blue-300 px-3 sm:px-4 py-2 text-xs sm:text-sm font-bold rounded shadow-sm transition-all flex-1 sm:flex-none">CSV Export</button>
                                <button onClick={generateNativePDF} disabled={isDownloading} className="bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 text-xs sm:text-sm font-bold rounded shadow-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2 flex-1 sm:flex-none">
                                    {isDownloading ? <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div> : 'Download PDF'}
                                </button>
                            </div>
                        </>
                    ) : (
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full bg-blue-50 text-blue-800 p-4 rounded-md border border-blue-200 shadow-sm gap-3">
                            <div>
                                <h4 className="font-bold text-sm sm:text-base">Single Model Workspace Active</h4>
                ...
                {activeView === 'comparison' && isComparing && leedResults ? (
                    <div className="space-y-8">
                        <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                            <div className={`p-4 sm:p-6 border-b border-slate-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 ${leedResults.compliant ? 'bg-emerald-50' : 'bg-red-50'}`}>
                                <div>
                                    <h4 className="text-base sm:text-lg font-black uppercase tracking-widest text-slate-900">LEED v4 Building Life-Cycle Impact Reduction</h4>
                                    <p className="text-xs sm:text-sm font-semibold text-slate-600 mt-1">Required: 10% GWP Reduction + 2 other categories. Max 5% penalty in any category.</p>
                                </div>
                                <div className={`px-4 sm:px-6 py-2 sm:py-3 rounded-lg border-2 font-black text-lg sm:text-xl uppercase tracking-widest ${leedResults.compliant ? 'bg-emerald-100 text-emerald-800 border-emerald-300' : 'bg-red-100 text-red-800 border-red-300'}`}>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-xs sm:text-sm text-left min-w-[600px]">
                                    <thead>
                                        <tr className="bg-slate-100 text-slate-600 uppercase text-[10px] sm:text-xs">
                                            <th className="p-3 sm:p-4 font-bold">Impact Category</th>
                                            <th className="p-3 sm:p-4 text-right font-bold">Baseline</th>
                                            <th className="p-3 sm:p-4 text-right font-bold">Proposed</th>
                                            <th className="p-3 sm:p-4 text-right font-bold">Reduction %</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {leedResults.metrics.map((m, idx) => (
                                            <tr key={idx} className="border-b border-slate-100">
                                                <td className="p-3 sm:p-4 font-bold text-slate-800">{m.label} {m.isReq && <span className="text-red-500 ml-1">*</span>}</td>
                                                <td className="p-3 sm:p-4 text-right font-mono text-slate-500">{m.base.toLocaleString(undefined, {maximumFractionDigits: 1})} {m.unit}</td>
                                                <td className="p-3 sm:p-4 text-right font-mono text-slate-900 font-semibold">{m.prop.toLocaleString(undefined, {maximumFractionDigits: 1})} {m.unit}</td>
                                                <td className={`p-3 sm:p-4 text-right font-mono font-black ${m.red >= 10 ? 'text-emerald-600' : m.red < -5 ? 'text-red-600' : 'text-slate-600'}`}>
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-4 sm:p-6">
                            <h4 className="text-base sm:text-lg font-bold text-slate-900 mb-4 sm:mb-6">Lifecycle System Boundary Visualization (A1-C4)</h4>
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                            <div className="p-4 sm:p-5 border-b border-slate-200 bg-slate-900 text-white">
                                <h4 className="text-base sm:text-lg font-bold">Itemized Carbon Reductions</h4>
                                ...
                                <table className="w-full text-xs sm:text-sm text-left border-collapse min-w-[700px]">
                                    <thead>
                                        <tr className="bg-slate-100 text-slate-600 uppercase text-[10px] sm:text-xs tracking-wider border-b border-slate-300">
                                            <th className="p-3 sm:p-4 font-bold">Material / Assembly Name</th>
                                            <th className="p-3 sm:p-4 text-right font-bold border-l border-slate-200">Baseline Qty</th>
                                            <th className="p-3 sm:p-4 text-right font-bold">Proposed Qty</th>
                                            <th className="p-3 sm:p-4 text-right font-bold border-l border-slate-200">Baseline Impact</th>
                                            <th className="p-3 sm:p-4 text-right font-bold">Proposed Impact</th>
                                            <th className="p-3 sm:p-4 text-right font-black text-slate-800 bg-slate-200 border-l border-slate-300">Delta Savings</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {deltaMatrix.map((item, idx) => {
                                            ...
                                            return (
                                                <tr key={idx} className="border-b border-slate-100 hover:bg-slate-50">
                                                    ...
                                                    <td className="p-3 sm:p-4 text-right font-mono text-slate-500 border-l border-slate-100">{item.bQty} {item.unit}</td>
                                                    <td className="p-3 sm:p-4 text-right font-mono text-slate-900 font-semibold">{item.pQty} {item.unit}</td>
                                                    <td className="p-3 sm:p-4 text-right font-mono text-slate-500 border-l border-slate-100">{item.bGwp.toLocaleString(undefined, {maximumFractionDigits:0})} kg</td>
                                                    <td className="p-3 sm:p-4 text-right font-mono text-slate-900 font-semibold">{item.pGwp.toLocaleString(undefined, {maximumFractionDigits:0})} kg</td>
                                                    <td className={`p-3 sm:p-4 text-right font-mono font-black border-l border-slate-200 ${isSavings ? 'text-emerald-600 bg-emerald-50/30' : isIncrease ? 'text-red-600 bg-red-50/30' : 'text-slate-400 bg-slate-50/30'}`}>
                    ...
                    <>
                        {activeTab === 'use' && (
                            <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-4 sm:p-6 mb-6">
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-6 border-b border-slate-200 pb-4 gap-4">
                                    <div>
                                        <h4 className="text-base sm:text-lg font-black uppercase tracking-widest text-slate-900">Embodied vs Operational Crossover</h4>
                                        <p className="text-xs sm:text-sm font-semibold text-slate-500 mt-1">Visualize the year operational carbon exceeds embodied impact for the <strong>{activeView}</strong> model.</p>
                                    </div>
                                    <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-start">
                                        <label className="text-xs font-bold text-slate-500 uppercase">Annual Energy (kWh)</label>
                                        <input type="number" value={annualEnergyKwh} onChange={(e) => setAnnualEnergyKwh(Number(e.target.value))} className="w-32 px-3 py-2 border-2 border-slate-300 rounded font-mono font-bold text-slate-900 focus:border-blue-500 outline-none text-sm" />
                                    </div>
                                </div>
                                <div className="h-[300px] sm:h-[400px] w-full">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <LineChart data={crossoverChartData} margin={{ top: 20, right: 10, left: 10, bottom: 5 }}>
                                            <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#e2e8f0" />
                                            <XAxis dataKey="year" tick={{ fill: '#475569', fontWeight: 'bold', fontSize: 10 }} />
                                            <YAxis tickFormatter={(val) => `${val / 1000}k`} tick={{ fill: '#475569', fontSize: 10 }} />
                                            ...
                                            <Legend wrapperStyle={{ paddingTop: '10px', fontSize: '12px' }} />
                                            <Line type="monotone" dataKey="Total_Carbon" stroke="#ef4444" strokeWidth={3} name="Total Carbon (Embodied + Operational)" />
                                            <Line type="monotone" dataKey="Embodied" stroke="#3b82f6" strokeWidth={2} strokeDasharray="5 5" name="Embodied Carbon Only" />
                                        </LineChart>
                                    </ResponsiveContainer>
                                </div>
                            </div>
                        ...
                        {activeTab === 'procurement' && (
                            <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-4 sm:p-6 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center bg-indigo-50 gap-4">
                                <div>
                                    <h2 className="text-xs sm:text-sm font-extrabold uppercase tracking-widest text-indigo-900">Bid Leveling & Procurement</h2>
                                    <p className="text-xs sm:text-sm font-semibold text-indigo-700 mt-1">Enter unit costs to calculate the Carbon per Dollar ratio.</p>
                                </div>
                                <div className="text-left sm:text-right w-full sm:w-auto">
                                    <div className="text-[10px] sm:text-xs font-bold text-indigo-500 uppercase tracking-widest mb-1">Total System Cost</div>
                                    <div className="text-2xl sm:text-3xl font-black text-indigo-900">${currentViewData?.totalCost.toLocaleString(undefined, {minimumFractionDigits:2, maximumFractionDigits:2})}</div>
                                </div>
                            </div>
                        )}

                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="bg-white p-4 sm:p-5 rounded-lg border border-slate-200 shadow-sm sm:col-span-2">
                                <div className="text-[10px] sm:text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Fossil Carbon (Phase Total)</div>
                                <div className="text-3xl sm:text-4xl font-extrabold text-slate-900">{currentViewData?.totalGwpFossil.toLocaleString(undefined, {maximumFractionDigits:0})} <span className="text-xs sm:text-sm font-semibold text-slate-500">kg CO₂e</span></div>
                            </div>
                            {activeTab === 'eol' ? (
                                <div className="bg-emerald-50 p-4 sm:p-5 rounded-lg border border-emerald-200 shadow-sm sm:col-span-2 flex justify-between items-center">
                                    <div>
                                        <div className="text-[10px] sm:text-xs font-bold text-emerald-700 uppercase tracking-widest mb-1">Module D: Reuse Savings</div>
                                        <div className="text-3xl sm:text-4xl font-extrabold text-emerald-600">{currentViewData?.totalModuleD.toLocaleString(undefined, {maximumFractionDigits:0})} <span className="text-xs sm:text-sm font-semibold text-emerald-500">kg CO₂e</span></div>
                                    </div>
                                    <svg className="w-10 h-10 sm:w-12 sm:h-12 text-emerald-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                                </div>
                            ) : (
                                <div className="bg-white p-4 sm:p-5 rounded-lg border border-green-200 shadow-sm sm:col-span-2">
                                    <div className="text-[10px] sm:text-xs font-bold text-green-700 uppercase tracking-widest mb-1">Biogenic Stored (Phase Total)</div>
                                    <div className="text-3xl sm:text-4xl font-extrabold text-green-700">{currentViewData?.totalGwpBiogenic.toLocaleString(undefined, {maximumFractionDigits:0})} <span className="text-xs sm:text-sm font-semibold text-green-600">kg CO₂e</span></div>
                                </div>
                            )}
                        </div>
                                ...
                                return (
                                    <div key={idx} className="border-b border-slate-100 p-4 hover:bg-slate-50 transition-colors">
                                        <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4 items-center">
                                            <div className="sm:col-span-4 font-bold text-slate-800 text-sm sm:text-base">
                                                {item.name}
                                            ...
                                            <div className="sm:col-span-3 flex items-center gap-2">
                                                <input type="number" value={item.qty} onChange={(e) => handleQuantityChange(item.originalIndex, e.target.value)} className="w-full sm:max-w-[6rem] px-2 py-1 border-2 border-slate-300 rounded bg-white text-right font-mono text-xs sm:text-sm font-bold text-slate-900 focus:border-blue-600 outline-none" />
                                                <span className="text-slate-500 text-[10px] font-bold uppercase">{item.unit}</span>
                                            </div>

                                            {activeTab === 'eol' && (
                                                <div className="sm:col-span-3 flex items-center gap-2">
                                                    <input type="number" placeholder="0" value={item.recycleRate || ''} onChange={(e) => handleEolChange(item.originalIndex, Number(e.target.value))} className="w-full sm:max-w-[5rem] px-2 py-1 border-2 border-emerald-300 rounded bg-white text-right font-mono text-xs sm:text-sm font-bold text-emerald-900 focus:border-emerald-600 outline-none" />
                                                    <span className="text-slate-500 text-[10px] font-bold uppercase whitespace-nowrap">% Recov</span>
                                                </div>
                                            )}
                                            ...
                                            {activeTab === 'procurement' && (
                                                <div className="sm:col-span-3 flex items-center gap-2">
                                                    ...
                                                    <input type="number" placeholder="Cost/Unit" value={item.unitCost || ''} onChange={(e) => handleCostChange(item.originalIndex, e.target.value)} className="w-full sm:max-w-[6rem] px-2 py-1 border-2 border-indigo-300 rounded bg-white text-right font-mono text-xs sm:text-sm font-bold text-indigo-900 focus:border-indigo-600 outline-none" />
                                                    <div className="text-[10px] font-black text-indigo-500 ml-1 whitespace-nowrap">
                                                        {item.totalCost > 0 ? `${(item.impact / item.totalCost).toFixed(2)} kgCO₂/$` : ''}
                                                    </div>
                                                </div>
                                            )}

                                            <div className={`sm:col-span-5 text-left sm:text-right font-mono font-bold text-sm sm:text-base ${(activeTab === 'procurement' || activeTab === 'eol') ? 'sm:col-span-2' : ''}`}>
